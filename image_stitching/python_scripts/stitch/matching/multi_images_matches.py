...
from stitch.matching.pair_match import PairMatch
...
class MultiImageMatches:
    ...
    def compute_matches(self, image_a: Image, image_b: Image) -> List:
        ...
        #matcher = cv2.DescriptorMatcher_create("BruteForce") # SIFT use
        matcher = cv2.DescriptorMatcher_create(cv2.DescriptorMatcher_BRUTEFORCE_HAMMING) # ORB use
        matches = []
